 ...
 * @returns The `AccountCard` component is being returned. It is a functional component that takes an
 * `account` object as a prop and renders a card displaying information about the account such as name,
 * balance, type, and default status. The card includes a header with the account name and a switch for
